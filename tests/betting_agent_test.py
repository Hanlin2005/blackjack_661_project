...
from training.train_betting_agent import load_and_run_model
from training.train_betting_agent import train_betting_agent_from_run_data
from training.train_betting_agent import evaluate_agent
import torch
from main import load_model
from agents.DQNAgent import DQNAgent
from environment.split_environment import BlackjackEnv
from agents.BettingModel import load_checkpoint, train_betting_nn
from agents.Supervised_betting import evaluate_nn_betting_agent

# Load playing agent
playing_agent = DQNAgent("full")
playing_agent.load_model("checkpoints/dqn/blackjack_agent_full_finished.pth")
print("Model loaded from checkpoints/dqn/blackjack_agent_full_finished.pth")

# Set up environment
env = BlackjackEnv(count_type="full")

# Load dictionary of count states and rewards
with open("data/count_reward_dict.pkl", "rb") as f:
