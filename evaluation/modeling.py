...
def model(agent):
    ...
    def compare_with_basic_strategy(agent):
        ...
        plt.tight_layout()
        plt.savefig('results/figures/blackjack_strategy_comparison.png')
        plt.show()
    ...
    def visualize_action_preferences(agent):
        ...
        plt.tight_layout()
        plt.savefig('results/figures/action_preferences.png')
        plt.show()
    ...
    def visualize_count_effect(agent, player_hand, dealer_hand, usable_ace, can_double, can_split):
        ...
        plt.tight_layout()
        plt.savefig('results/figures/action_preferences_over_count_range.png')
        plt.show()
